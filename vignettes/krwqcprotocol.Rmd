...
### QC5 - QC Status
In de functie voor QC5 worden de attributes met resultaten uit de verschillende
tests uit het metingen gehaald en elkaar toegevoegd als één dataframe. Deze wordt 
vervolgens gebruikt om het eind oordeel te bepalen volgens de regels uit het Protocol. 

... verder aanvullen, deze test was nog niet beschikbaar.
